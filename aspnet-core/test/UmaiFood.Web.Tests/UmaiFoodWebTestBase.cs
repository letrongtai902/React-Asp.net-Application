...
namespace UmaiFood.Web.Tests
{
    public abstract class UmaiFoodWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UmaiFoodWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UmaiFoodWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UmaiFoodDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UmaiFoodDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UmaiFoodDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UmaiFoodDbContext, Task<T>> func)
        {
            T result;
